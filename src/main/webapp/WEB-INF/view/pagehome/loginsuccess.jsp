        ...
        <div data-v-67ef3a4a class="layout clear">
            <div data-v-67ef3a4a class="left csdnav">
                <label data-v-67ef3a4a>
                    ...
                    <a data-v-67ef3a4a href="${pageContext.request.contextPath}/manager/myinfo" class="colorRed">${user.tel}/</a>
                ...
                <a data-v-67ef3a4a="" href="https://www.chesudi.com/module/helpCenter.html">帮助中心</a>
            </div>
            <div data-v-67ef3a4a="" class="right phone">
                <div data-v-67ef3a4a="" class="typeTab">
                    <a data-v-67ef3a4a="" href="javascript:void(0)" style="color: rgb(199, 0, 11);">中文</a>&nbsp;/&nbsp;
                    <a data-v-67ef3a4a="" href="javascript:void(0)">English</a>
                </div>
                <div data-v-67ef3a4a="" class="menu">
                    <a data-v-67ef3a4a="" href="${pageContext.request.contextPath}/manager/mymain">我的车速递</a>
                </div>
                <div data-v-67ef3a4a="">
    ...
    <div data-v-39f7f629 class="csdnav">
        <div data-v-39f7f629="" class="layout clear">
            <div data-v-39f7f629="" class="left logo">
                <a data-v-39f7f629="" href="javascript:void(0)">
            ...
            <div data-v-39f7f629="" class="left navCom">
                <ul data-v-39f7f629="">
                    ...
                    <li data-v-39f7f629="">
                        <a data-v-39f7f629="" href="${pageContext.request.contextPath}/city/shortrent" target="_self" class="">短租自驾</a>
                    </li>
                    <li data-v-39f7f629="">
                        <a data-v-39f7f629="" href="" target="_self" class="colorRed">
