...
<div id="app" class="bgGray">
    <div data-v-95ac8d30="" class="header3">
        <div data-v-95ac8d30="" class="layout clear">
            ...
            </div> <div data-v-95ac8d30="" class="header3Nav right">|<a data-v-95ac8d30="" href="mymain">我的订单</a>|<a data-v-95ac8d30="" href="https://www.chesudi.com/module/helpCenter.html">帮助中心</a>|<a data-v-95ac8d30="" href="${pageContext.request.contextPath}/load/loginsuccess">退出</a>
        </div>
                ...
                <div class="userInfoL left">
                    <div data-v-1cae2c34="" class="userNav">
                        ...
                        <ul data-v-1cae2c34="" class="manNav">
                            <li data-v-1cae2c34="">
                                <a data-v-1cae2c34="" href="${pageContext.request.contextPath}/manager/mymain" class="sel">订单管理</a>
                            </li>
                             <li data-v-1cae2c34="">
                                 <a data-v-1cae2c34="" href="${pageContext.request.contextPath}/manager/myinfo" class="">个人信息</a>
                             </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="noData" id="noda">
                                    ...
                                    <table cellspacing="0" cellpadding="0">
                                        <tr class="firstTr" v-for="site in obj">
                                            ...
                                            <td>{{site.backcity}}</td>
                                            <td>{{site.status}}</td>
                                            <td><a class="click" :val="site.id" style="color:red" href="javascript:void(0)">删除</a></td>
                                        </tr>
                                    </table>
...
<script type="text/javascript">
    ...
    function loadData(page) {
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/manager/allOrder?page="+page,
            dataType:"json",
            async: false,
...
$(function () {
    $(".click").click(function () {
        ...
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/manager/delete?id="+id,
            dataType:"json",
            success:function(data) {
                if(data.code==1){
                    //window.location.replace("/manager/allOrder")
                    loadData(1)
                }else{
                    alert(data.msg)
                }
