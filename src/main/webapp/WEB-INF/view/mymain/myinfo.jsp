...
<div id="app" class="bgGray">
    <div data-v-95ac8d30="" class="header3">
        <div data-v-95ac8d30="" class="layout clear">
            ...
            </div> <div data-v-95ac8d30="" class="header3Nav right">|<a data-v-95ac8d30="" href="${pageContext.request.contextPath}/manager/mymain">我的订单</a>|<a data-v-95ac8d30="" href="https://www.chesudi.com/module/helpCenter.html">帮助中心</a>|<a data-v-95ac8d30="" href="${pageContext.request.contextPath}/load/loginsuccess">退出</a>
        </div>
                ...
                <div class="userInfoL left">
                    <div data-v-1cae2c34="" class="userNav">
                        ...
                        <ul data-v-1cae2c34="" class="manNav">
                            <li data-v-1cae2c34="">
                                <a data-v-1cae2c34="" href="${pageContext.request.contextPath}/manager/mymain" class="">订单管理</a>
                            </li>
                            <li data-v-1cae2c34="">
                                <a data-v-1cae2c34="" href="${pageContext.request.contextPath}/manager/myinfo" class="sel">个人信息</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<div class="site-demo-button" id="layerDemo" style="margin-bottom: 0;">
                        <div class="orderList list" id="noda">
                                    <table  class="tableinfo">
                                        ...
                                        <tr>
                                            <td><button @click="openmodal()" data-type="auto" class="layui-btn layui-btn-normal">修改基本信息</button></td>
                                            <td><button @click="openmodal2()" data-type="auto" class="layui-btn layui-btn-normal">修改密码</button></td>
                                        </tr>
                                    </table>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" >
        <div class="modal-content">
            ...
            <div class = "modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="edit()" id="modify">修改</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class ="modal-body" >
                <div class="input-group">
                    ...
                    <input class="input-sm" type="text" id="oldpass" placeholder="oldpass" value=""/>
                </div>
                <br/>
                <div class="input-group">
                    <span class="input-group-addon">新密码:</span>
                    <input class="input-sm" type="text" id="newpass" placeholder="newpass" value=""/>
                </div>

            </div>
            <div class = "modal-footer">
                <button type="button" class="btn btn-default" data-dismiss ="modal">取消</button>
                <button type="button" class="btn btn-primary" onclick="editpass()">修改</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    function refreinfo() {
        window.location.replace("${pageContext.request.contextPath}/manager/myinfo");
    }
</script>
...
<script type="text/javascript">
    var vm = new Vue({
        ...
        methods:{
            openmodal:function () {
                $.ajax({
                    url:"${pageContext.request.contextPath}/manager/userInfo",
                    dataType:"json",
                    success:function (data) {
                        vm1.reltel=data.tel;
                        vm1.relemail=data.email;
                    }
                });
    ...
    function edit(){
        if(confirm("确认要修改吗?")){
            $.ajax({
                ...
                data:{"tel":vm1.reltel,"email":vm1.relemail},
                dataType:"json",
                success:function(data){
                    if(data.code==1){
                        alert(data.msg)
...
<script>
    ...
    function editpass() {
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath}/manager/updatePassword",
